...
public class Dialog extends javax.swing.JFrame {
    ...
    /*private void refreshEntity(String nomorSeri) {
        try {
            if (em != null && em.isOpen()) {
                PenjualanPerangkatElektronik_1 entity = em.find(PenjualanPerangkatElektronik_1.class, nomorSeri);
                if (entity != null) {
                    em.refresh(entity);
                }
            }
        } catch (Exception e) {
            System.out.println("Warning: Tidak bisa refresh entity: " + e.getMessage());
        }
    }*/
